export function renderLoginPage({ encabezadoExterno }) {
  return `
            ...
            <div class="col-12 col-md-8 col-lg-5">
              <div class="card border-0 shadow-lg" style="border-radius: 15px;">
                <div class="card-body p-5">
                  ...
                  <button type="button" class="btn btn-outline-dark w-100 d-flex align-items-center justify-content-center gap-3 mb-2 fw-semibold" style="border-radius: 10px; min-height: 46px; background-color: #fff; box-shadow: 0 4px 14px rgba(15, 23, 42, 0.08);">
                    <svg width="18" height="18" viewBox="0 0 24 24" aria-hidden="true">
                      <path fill="#EA4335" d="M12 10.2v3.9h5.4c-.2 1.2-1.4 3.5-5.4 3.5-3.2 0-5.9-2.7-5.9-6s2.7-6 5.9-6c1.8 0 3 .8 3.7 1.5l2.5-2.4C16.6 3.2 14.5 2.2 12 2.2 6.9 2.2 2.8 6.4 2.8 11.6S6.9 21 12 21c6.9 0 9.1-4.8 9.1-7.3 0-.5 0-.8-.1-1.2H12z"/>
                      <path fill="#4285F4" d="M21.6 12.3c0-.7-.1-1.4-.2-2.1H12v4h5.4c-.2 1.1-.9 2.1-1.8 2.8v2.3h2.9c1.7-1.6 3.1-4 3.1-7z"/>
                      <path fill="#FBBC05" d="M12 22c2.5 0 4.6-.8 6.1-2.1l-2.9-2.3c-.8.6-1.9 1-3.2 1-2.5 0-4.6-1.7-5.4-4H3.6v2.5C5.1 19.7 8.3 22 12 22z"/>
                      <path fill="#34A853" d="M6.6 14.6c-.2-.7-.4-1.4-.4-2.1s.1-1.4.4-2.1V7.9H3.6C2.9 9.2 2.5 10.6 2.5 12s.4 2.8 1.1 4.1l3-1.5z"/>
                    </svg>
                    Iniciar con Google
                  </button>
