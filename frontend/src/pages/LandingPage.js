export function renderLandingPage({ encabezadoExterno }) {
  return `
    ${encabezadoExterno({ rightHref: '/login', rightText: 'Acceder' })}
    ...
    <section id="home" class="hero-section">
      <div class="container">
        <div class="row align-items-center position-relative">
          ...
          <div class="col-lg-6">
            <div class="hero-img wow fadeInUp d-flex align-items-center justify-content-center" data-wow-delay=".5s" style="min-height: 440px;">
              <img src="/assets/img/hero/dashboard-generico-usuario.svg" alt="Vista de dashboard de usuario" />
            </div>
          </div>
        </div>
      </div>
